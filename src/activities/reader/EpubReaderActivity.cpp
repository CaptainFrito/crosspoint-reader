...
void EpubReaderActivity::renderScreen() {
  ...
  if (!section) {
    ...
    if (!section->loadSectionFile(SETTINGS.getReaderFontId(), SETTINGS.getReaderLineCompression(),
      ...
      const auto popupFn = [this]() { UITheme::drawPopup(renderer, "Indexing..."); };
...
void EpubReaderActivity::renderStatusBar(const int orientedMarginRight, const int orientedMarginBottom,
  ...
  if (showProgressBar) {
    ...
    UITheme::drawBookProgressBar(renderer, static_cast<size_t>(bookProgress));
  }

  if (showBattery) {
    UITheme::drawBattery(renderer, Rect{orientedMarginLeft + 1, textY, metrics.batteryWidth, metrics.batteryHeight},
